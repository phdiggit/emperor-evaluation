...
from scripts.dev import retrieval_v3_intake_manifest
from scripts.dev import retrieval_v3_intake_rows as tool
...
def write_manifest_fixture(tmp_path: Path, *, duplicate_passage: bool = False) -> Path:
    ...
    manifest = retrieval_v3_intake_manifest.build_manifest(summary_paths=[summary])
        ...
        json.dumps(
            {
                ...
                "retrieval_v3_consumption": str(consumption_root),
            },
            ensure_ascii=False,
            indent=2,
        ),
