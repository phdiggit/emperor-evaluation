...
def _quantity():
    return {
        "quantity_role": "TOTAL_EXPEDITION_FORCE",
        "affected_group": "synthetic vanguard",
        "loss_type": "DEATH_WITH_UNRESOLVED_GROUP_SCOPE",
        "basis": "The rear guard left; its share is unknown.",
        "source_refs": ["synthetic-source"],
        "denominator_status": "UNRESOLVED",
        "reliable_death_lower_bound": None,
        "threshold_path_admitted": False,
    }
...
def test_unknown_casualties_remain_unknown_and_cannot_pass_personnel_gate():
    ...
    validate_quantity_inference_review({
        **review,
        "denominator_status": "CONFIRMED",
        "reliable_death_lower_bound": 100000,
        "threshold_path_admitted": True,
    })


def _views(root):
    row = {
        "ruler_id": "synthetic-a",
        "ruler_name": "合成甲",
        "polity": "合成政权",
        "rank": 1,
        "score": 0.0,
        "second_item_score": 0.0,
        "governance_method_score": 0.0,
        "governance_result_score": 0.0,
        "handoff_score": 0.0,
        "A_direction_index": 0.0,
        "B1_direction_index": 0.0,
        "B2_direction_index": 0.0,
        "AB_block_120": 0.0,
        "B2_45": 0.0,
        "D1_level": 0,
        "D3_level": 0,
...
@pytest.mark.parametrize(
    ...
    [
        METHOD_PATH,
        TOTAL_PATH,
        FINANCE_PATHS["C1"].with_name("05-治理结果正式结算.json"),
        TOTAL_PATH.parent / "政权交接稳定/03-交接质量20分正式结算.json",
    ],
)
...
def _analysis_inputs():
    records = [
        {
            ...
            "rank": 1,
            "total_score": 85.0,
            "third_item_score": 80.0,
            "second_item_score": 5.0,
            "fourth_item_adjustment": 0.0,
            "first_item_raw_score": None,
        },
        {"ruler_id": "b", "ruler_name": "合成乙", "rank": 2, "total_score": 70.0},
    ]
    third = {
        "a": {
            "global_cost_credit_profile": {"cost_band": "C5", "position": "HIGH"},
            "military_net_loss_penalty": 0,
            "A120_score_points": 60.0,
            "B80_score_points": 30.0,
            "C50_score_points": 10.0,
        }
    }
    ...
    case = {
        "case_id": "synthetic",
        "ruler_id": "a",
        "baseline_cost_band": "C5",
        "baseline_cost_position": "HIGH",
        ...
        "scenarios": [
            ...
            },
            {
                ...
                "cost_band": "C6",
                "cost_position": "HIGH",
                "basis": "synthetic excluded inference",
            },
        ],
    }
