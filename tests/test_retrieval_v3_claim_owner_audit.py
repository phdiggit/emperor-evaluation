...
from scripts.dev import retrieval_v3_claim_owner_audit as tool
...
def test_owner_audit_reads_atomic_fact_view_without_direction_hint() -> None:
    source = (tool.ROOT / "scripts/dev/retrieval_v3_claim_owner_audit.py").read_text(encoding="utf-8")

    assert "from retrieval_v3.claim_atomic_facts" in source
