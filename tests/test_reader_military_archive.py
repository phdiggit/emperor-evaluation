...
def test_military_archive_template_uses_final_public_header_copy():
    template = (Path(__file__).resolve().parents[1] / "reader" / "military.template.html").read_text(encoding="utf-8")
    assert "战役与统帅档案" in template
