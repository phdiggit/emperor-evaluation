...
def test_postgres_schema_avoids_varchar_and_keeps_data_untouched() -> None:
    ...
    allowed_data_changes = {
        ...
        "data/batches/i5b_typical_batch_b1_qin_han/source_evidence_specs.jsonl",
        "data/batches/i5b_typical_batch_b1_qin_han/source_pack.jsonl",
        "data/batches/i5b_typical_batch_b1_qin_han/source_review_log.jsonl",
