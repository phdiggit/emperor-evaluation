...
ALLOWED_CREATED_SEARCH_IDS = {
    ...
    "SRCH-I5B-LIUCHE-NEG-KULI-001",
    "SRCH-I5B-LIUCHE-POS-SHIREN-001",
    "SRCH-I5B-LIUCHE-POS-SHOUQUAN-001",
    ...
    "SRCH-I5B-LIUQI-NEG-CHAOCOU-001",
    "SRCH-I5B-LIUQI-NEG-ZHOUYAFU-001",
    "SRCH-I5B-LIUQI-POS-ZHOUYAFU-001",
    ...
    "SRCH-I5B-LIUXUN-POS-BINGJI-001",
    "SRCH-I5B-LIUXUN-POS-HUANGBA-001",
    ...
    "SRCH-I5B-YANGGUANG-NEG-GAOJIONG-001",
    "SRCH-I5B-YANGGUANG-NEG-YUSHIJI-001",
    "SRCH-I5B-YANGGUANG-POS-YUSHIJI-001",
    "SRCH-I5B-YANGJIAN-NEG-GONGCHEN-001",
    "SRCH-I5B-YANGJIAN-POS-RONGJIAN-001",
    "SRCH-I5B-YANGJIAN-POS-SHIREN-001",
    "SRCH-I5B-YANGJIAN-POS-SHOUQUAN-001",
...
def test_export_md_generates_i5b_trial_search_leads_view() -> None:
    ...
    export_result = run_script("export_md.py", "--profile", "all")
...
def test_sources_are_only_public_text_sources_added_by_source_review_tasks() -> None:
    ...
    assert {
        ...
        "SRC-SJ-J111-WEIQING-LIUCHE-001",
        "SRC-SJ-J122-ZHANGTANG-LIUCHE-001",
        "SRC-SS-J41-GAOJIONG-SUWEI-YANGJIAN-001",
        "SRC-SS-J53-SHIWANSUI-YANGJIAN-001",
    }.issubset(source_ids)
