...
from scripts.dev import retrieval_v3_claim_cache_intake_bridge as tool
from scripts.dev import retrieval_v3_import_plan as import_plan
...
def test_hydrate_full_texts_resolves_linux_runtime_path_to_smb_root(tmp_path) -> None:
    ...
    run_dir = active_root / "retrieval_v3_claim_extraction_runs" / "run"
        ...
        [
            {
                ...
                "raw_output_path": "/data1/emperor-evaluation/runtime/active/retrieval_v3_claim_extraction_runs/run/judge_result.final.json",
            }
        ],
        full_texts={},
        runtime_paths={
