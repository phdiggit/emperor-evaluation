...
class FakeCursor:
    ...
    def execute(self, sql: str, params=None) -> None:
        ...
        if "from retrieval_v3.eval_rule_factors f" in routed:
            self.rows = [dict(row) for row in self.conn.factor_option_rows]
            self.row = None
            return
        if "from retrieval_v3.claim_rule_bindings crb" in routed:
            ...
            self.rows = []
            return
        if "insert into retrieval_v3.claim_rule_binding_factor_judgments" in routed:
            self.row = {"id": 900}
            self.rows = []
            return
        self.row = None
    ...
    def __init__(self) -> None:
        ...
        self.binding_rows = {
            ...
            "BND-BLOCKED": {
                ...
                "binding_payload": {"source": "retrieval_v3_candidate_promoter", "candidate_id": 120},
                "source_pack_id": 30,
                "target_id": 40,
                "item_code": "I5B",
                "candidate_id": 120,
