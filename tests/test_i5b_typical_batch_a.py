...
BATCH_DIR = ROOT / "data" / "batches" / "i5b_typical_batch_a"
...
def test_batch_a_persistent_research_assets_are_only_liuche_and_yangjian() -> None:
    ...
    assert {row["person"] for row in spec_rows} == {"刘彻", "杨坚"}
    assert {row["person"] for row in source_pack_rows} == {"刘彻", "杨坚"}
    assert {row["person"] for row in review_rows} == {"刘彻", "杨坚"}
    ...
    } == {"source_verified_evidence_created", "lead_needs_source_review"}


def test_batch_a_source_pack_rows_preserve_locator_excerpt_and_context() -> None:
    source_pack_rows = read_jsonl(SOURCE_PACK_PATH)

    for row in source_pack_rows:
        assert row["batch_id"] == "i5b_typical_batch_a_20260628"
...
def test_batch_a_review_log_keeps_converted_and_still_review_leads() -> None:
    review_rows = rows_by_id(SOURCE_REVIEW_LOG_PATH, "search_id")

    converted = {
        "SRCH-I5B-LIUCHE-POS-SHIREN-001": "EVD-I5B-LIUCHE-POS-WEIQING-AUTH-001",
        "SRCH-I5B-LIUCHE-POS-SHOUQUAN-001": "EVD-I5B-LIUCHE-POS-WEIQING-AUTH-001",
        "SRCH-I5B-LIUCHE-NEG-KULI-001": "EVD-I5B-LIUCHE-NEG-ZHANGTANG-KULI-001",
        "SRCH-I5B-YANGJIAN-POS-SHIREN-001": "EVD-I5B-YANGJIAN-POS-GAOJIONG-AUTH-001",
        "SRCH-I5B-YANGJIAN-POS-SHOUQUAN-001": "EVD-I5B-YANGJIAN-POS-GAOJIONG-AUTH-001",
        "SRCH-I5B-YANGJIAN-POS-RONGJIAN-001": "EVD-I5B-YANGJIAN-POS-SUWEI-RONGJIAN-001",
        "SRCH-I5B-YANGJIAN-NEG-GONGCHEN-001": "EVD-I5B-YANGJIAN-NEG-SHIWANSUI-MERIT-001",
    }
    ...
    still_review = {
        "SRCH-I5B-LIUCHE-POS-TONGDAO-001",
        "SRCH-I5B-LIUCHE-NEG-WUGU-001",
        "SRCH-I5B-LIUCHE-CUT-ADJACENT-001",
        "SRCH-I5B-YANGJIAN-NEG-NEIXING-001",
        "SRCH-I5B-YANGJIAN-CUT-ADJACENT-001",
    }
...
def test_batch_a_canonical_rows_trace_to_source_pack_and_search_logs() -> None:
    source_pack_rows = read_jsonl(SOURCE_PACK_PATH)
    review_rows = rows_by_id(SOURCE_REVIEW_LOG_PATH, "search_id")
    ...
    assert {
        "QRY-I5B-LIUCHE-20260618",
        "QRY-I5B-YANGJIAN-20260618",
    ...
    for source_pack in source_pack_rows:
        ...
        for cluster_id in source_pack["linked_cluster_ids"]:
            ...
            assert set(source_pack["linked_evidence_ids"]).issubset(cluster["linked_evidence_ids"])
