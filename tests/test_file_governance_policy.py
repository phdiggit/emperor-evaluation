...
ALLOWED_CHANGED_FILES = {
    ...
    "docs/adr/ADR-schema-diff-draft-renderer.md",
    "docs/adr/ADR-migration-bundle-review-pack.md",
    ...
    "docs/adr/ADR-production-schema-live-apply-execution-preflight.md",
    "docs/adr/ADR-production-schema-live-apply-execution.md",
    "docs/adr/ADR-production-seed-data-apply-execution.md",
    "docs/adr/ADR-production-migration-freeze-checklist.md",
    ...
    "scripts/platform/guarded_executable_migration_pr.py",
    "scripts/platform/migration_sql_draft_renderer.py",
    "scripts/platform/schema_change_candidate_review_bundle.py",
    "scripts/platform/schema_change_approval_gate_package.py",
    "scripts/platform/schema_change_explicit_approval_request_handoff.py",
    "scripts/platform/schema_changing_formal_schema_update.py",
    "scripts/platform/production_schema_live_apply_entrypoint_guard.py",
    "scripts/platform/production_schema_live_apply_execution_pr_scaffold.py",
    "scripts/platform/production_schema_live_apply_execution_preflight.py",
    "scripts/platform/production_schema_live_apply_execution.py",
    "scripts/platform/production_seed_data_apply_execution.py",
    "scripts/platform/schema_change_pr_prep_pack.py",
    "scripts/platform/schema_diff_draft_renderer.py",
    "scripts/platform/migration_bundle_review_pack.py",
    "scripts/platform/production_migration_freeze_checklist.py",
    "scripts/platform/production_migration_pr_scaffold.py",
    ...
    "tests/test_guarded_executable_migration_pr.py",
    ...
    "tests/test_schema_changing_formal_schema_update.py",
    "tests/test_production_schema_live_apply_entrypoint_guard.py",
    ...
    "tests/test_schema_change_pr_prep_pack.py",
    ...
    "tests/test_production_migration_pr_scaffold.py",
