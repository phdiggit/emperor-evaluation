...
def test_canonical_pool_is_rebuildable_and_feasible() -> None:
    ...
    assert payload["composite_ready_count"] == 148
    assert payload["pending_second_item_count"] == 36
...
def test_checked_in_pool_matches_current_settlements() -> None:
    ...
    assert report["pending_second_item_count"] == 36
