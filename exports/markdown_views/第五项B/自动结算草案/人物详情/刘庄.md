...
* **正向证据簇（positive_cluster_ids）**：[见附录：正向证据簇（positive_cluster_ids）](../附录/刘庄_长字段附录.md#appendix-positive_cluster_ids)
* **负向证据簇（negative_cluster_ids）**：[见附录：负向证据簇（negative_cluster_ids）](../附录/刘庄_长字段附录.md#appendix-negative_cluster_ids)
...
* **负向边界档（negative_boundary_tier）**：adjacent_item_medium_residual
