...
| 人物 | 自动结算方向 | 置信度 | 负向边界档 | 是否阻断 | 规则敏感点 |
| --- | --- | --- | --- | --- | --- |
| 李世民 | 高位强正，上探极正候选 | high_mid | 弱至中 | 否 | 弱负上调中负边界 |
| 刘秀 | 强正受压制，不上探极正 | medium_high | 中至强 | 是 | 中负上调强负边界；强负核心压制强正 |
| 刘庄 | 中正受中负压制 | medium | 相邻项剥离后中度剩余 | 否 | 相邻项主导剥离；B项剩余默认中负 |
