...
| --- | --- | --- | --- | --- | --- | --- | --- |
| ADJ-I5B-LISHIMIN-POS-TALENT-ECOSYSTEM-001 | positive | talent_ecosystem_and_authorization | ["EVD-I5B-LISHIMIN-POS-SHIREN-FANGDU-001", "EVD-I5B-LISHIMIN-POS-SHIREN-WEIZHENG-001", "EVD-I5B-LISHIMIN-POS-SHOUQUAN-LIJING-001", "EVD-I5B-LISHIMIN-POS-RONGJIAN-WEIZHENG-001"] | 3 | extreme_positive_candidate_after_more_cross_type_evidence_and_human_review | source_verified_pending_human_adjudication | 已回源正证覆盖幕府聚才、旧敌阵营人才转用、关键军事人才授权、谏臣反馈入口四个维度，说明李世民第五项B不是单点任人，而是具备多类型人才吸纳与授权生态的强正候选。当前证据组仍缺李勣、尉迟敬德等后续补充线，不直接写为极正。 |
...
| EVD-I5B-LISHIMIN-NEG-WEIZHENG-001 | negative | 弱负 | 疑忌杀害 | SRC-ZZTJ-J197-198-WEIZHENG-001 | 上始疑征阿黨……踣所撰碑；魏徵若在，不使我有是行也！……復立所制碑。 | B项只计谏臣身后政治信用与信任逆转的弱负候选；魏征生前纳谏正证不在本任务处理，政策纠错效果切第二项B2，皇帝认知/反思能力切第五项E；复碑与恢复评价材料作为减轻因素。 | 弱负候选证据；不得直接入分，待人工裁判。 | source_verified_pending_human_adjudication |
