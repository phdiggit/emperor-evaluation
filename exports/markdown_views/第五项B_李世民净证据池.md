...
| EVD-I5B-LISHIMIN-NEG-WEIZHENG-001 | negative | 中负 | 谏臣身后信用反转 | SRC-ZZTJ-J197-198-WEIZHENG-001 | 上始疑征阿黨……踣所撰碑；魏徵若在，不使我有是行也！……復立所制碑。 | B项只计顶级谏臣身后政治信用与表达安全预期的剩余损伤；魏征生前纳谏正证另入正向证据组，政策纠错效果切第二项B2，皇帝认知/反思能力切第五项E；复碑与恢复评价只作为减轻与封顶因素，不改写本项中负剩余。 | 中负候选证据；单证自动定级，不得上探强负，不得直接入分。 | source_verified_pending_human_adjudication |
