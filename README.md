...
- 李世民当前影子结果：149个 Episode、50个 REU、122条统一成果簇，本纪补证链接15条、治理结果支持10条，加权净信号 `21.328021`。
- 刘邦当前影子结果：26个 Episode、27个 REU、14条统一成果簇，本纪补证链接4条、治理结果支持3条；周勃“屠马邑”按毁灭性攻城校准为 `serious`、有断句争议的“屠浑都”不累计严重度后，加权净信号为 `14.877213`。
