...
- 文件治理与批次/主表边界以 `docs/项目总纲/数据层级与批次文件治理规则.md` 为准；已合并的 correction batch 不应长期留存。
- 下一阶段是迁移规则和已回源史料，不迁移旧评分。
- 当前可先阅读 `docs/通用方法论/数据主表字段规范.md`、`docs/操作规范/稳定标识命名规范.md` 和 `exports/markdown_views/第五项B/人工审核/入口/第五项B试点计划.md`。
...
详细步骤见 [`docs/操作规范/GitHub发布与认证规范.md`](docs/操作规范/GitHub发布与认证规范.md)。
