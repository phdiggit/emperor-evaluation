...
- 第二至第六项共同正收益上限为1000分，其中第四项135分、第五项120分、第六项90分；第一项条件附加公式中的`M`同步取1000。
...
第一项当前原始满分为240分，结构为A100、B60、C80（C1成果50、C2本人前线指挥30）。原始分只在适用奠基人之间比较，不直接加入第二至第六项共同分母；综合榜按`F = 0.10 × M × (第一项原始分/240)^1.25`计算条件附加分，再以`T = S_common + F - D7`合成。
