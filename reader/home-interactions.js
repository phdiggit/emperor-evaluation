...
(() => {
  ...
  function thirdPublicText(value, itemLabel = "") {
    ...
    text = text
      ...
      .replace(/\bA1主要安全威胁与战略主动\b/g, "主要安全威胁与战略主动")
      .replace(/\bA2防线协同与战略纵深\b/g, "防线协同与战略纵深")
      .replace(/\bB1实际控制范围\b/g, "实际控制范围")
      .replace(/\bB1控制规模\b/g, "控制范围")
      .replace(/\bB2战略成果价值\b/g, "战略成果价值")
      .replace(/\bB2战略价值\b/g, "战略价值")
      .replace(/\bB4控制成果稳定性\b/g, "控制成果稳定性")
      .replace(/\bB4交班成熟度\b/g, "成果稳定性")
