...
17. `分项规则/第一项创业与政权取得能力/战略决策能力/00-规则与计分合同.md`
18. `评分结算/第一项创业与政权取得能力/战略决策能力/01-秦至唐第一项A战略决策能力结算.md`
19. `分项规则/第一项创业与政权取得能力/政治整合能力/00-规则与计分合同.md`
20. `评分结算/第一项创业与政权取得能力/政治整合能力/01-秦至唐第一项B政治整合能力结算.md`
21. `评分结算/第一项创业与政权取得能力/01-第一大项结算总结分析.md`
21. `分项规则/第一项创业与政权取得能力/军事夺取能力/00-规则与计分合同.md`
22. `../config/first-item-c-territorial-control.schema.json`
23. `评分结算/第一项创业与政权取得能力/军事夺取能力/01-秦至唐第一项C军事夺取能力结算.md`
24. `分项规则/第五项统治者政治素质/B用人与授权.md`
