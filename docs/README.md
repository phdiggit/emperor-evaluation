...
当前实现状态为 `M1 conditional_pass / G2.6J failed_closed / G2.6K0 active`。G2.6K0 已建立 Source Cache v2、确定性 section-aware slicer、S1—S5 机械早停和 8 场景 protocol smoke；G2.6I/J 作为开放开发回归集仍在 S1/S2 阻断，不能进入 PostgreSQL G3。
