...
19. `评分结算/第一项创业与政权取得能力/战略决策能力/01-秦至唐第一项A战略决策能力结算.md`
20. `分项规则/第一项创业与政权取得能力/政治整合能力/00-规则与计分合同.md`
21. `评分结算/第一项创业与政权取得能力/政治整合能力/01-秦至唐第一项B政治整合能力结算.md`
22. `评分结算/第一项创业与政权取得能力/01-第一大项结算总结分析.md`
23. `分项规则/第一项创业与政权取得能力/军事夺取能力/00-规则与计分合同.md`
24. `../config/first-item-c-territorial-control.schema.json`
25. `评分结算/第一项创业与政权取得能力/军事夺取能力/01-秦至唐第一项C军事夺取能力结算.md`
