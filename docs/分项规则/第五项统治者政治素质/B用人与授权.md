...
成果先按独立责任链合并为成就簇。同一职责链、同一结果的连续步骤和重复同类事项只算一个成就簇；官职、受宠、参会、列名、未实施建议和一般声望不构成成就簇。共同成果必须说明本人承担的独立责任，低归属材料只能辅助，不得单独抬档。
...
| `top` | 顶级人才 | 1.20 | 达到国家级、决定性战区、重要制度或领域第一梯队高度，并另有稳定兑现、第二个重大成果或重要方法与遗产之一；本人归属必须高 | 需要权威材料确认其处于同时代或相应领域第一梯队；单一高峰、共同参与、名望或一项代表作通常不足，未达到时代塑造高度仍不得进入 `historic` |
| `historic` | 历史级人才 | 1.60 | 必须达到时代或文明塑造高度，并同时具备以下至少一项：多次高风险重大兑现、形成跨阶段长期有效的基础制度或作品、在多个独立领域达到顶级高度 | 需要强权威共识、清楚的个人归属和跨阶段影响证据；单次国家级成果、长期任高位、传统名臣名将标签或史料篇幅均不得单独过档 |

定档按以下顺序执行：

1. 从精确史源中提取并合并独立成就簇，记录规模、本人归属、实现结果、持续性和失败成本；
2. 仅按实绩门槛确定能力上限，不读取旧人才等级；
