...
from scripts.dev.retrieval_v3_clean_summary import judge_anomalies  # noqa: E402
from scripts.dev.retrieval_v3_intake_manifest import repo_relative, text  # noqa: E402
from scripts.dev import retrieval_v3_runtime_paths as runtime_paths  # noqa: E402
...
def default_package_name(manifest_path: Path) -> str:
    ...
    return parent or stem or "retrieval_v3_consumption"
...
def write_rowset(rows: Mapping[str, Sequence[Mapping[str, Any]]], output_root: Path) -> dict[str, Any]:
    ...
    summary = {
        "generated_by": "scripts/dev/retrieval_v3_intake_rows.py",
        "files": files,
        "totals": totals,
    }
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Expand retrieval_v3 intake manifest into normalized staging JSONL rows.")
