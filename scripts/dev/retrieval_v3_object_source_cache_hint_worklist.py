...
from scripts.dev.retrieval_v3_object_source_cache_audit import build_review_audit, read_jsonl
...
def build_source_hint_worklist(
    ...
    *,
    ...
    return {
        "generated_by": "scripts/dev/retrieval_v3_object_source_cache_hint_worklist.py",
...
def render_source_hint_worklist_markdown(worklist: Mapping[str, Any]) -> str:
    ...
    lines = [
        "# retrieval_v3 object source hint correction worklist",
        "",
