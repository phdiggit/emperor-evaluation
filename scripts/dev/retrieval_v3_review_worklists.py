...
from scripts.dev.retrieval_v3_contracts import alias_script_variants  # noqa: E402
...
def summarize_worklists(*, object_rows: Sequence[Mapping[str, Any]], material_rows: Sequence[Mapping[str, Any]]) -> dict[str, Any]:
    ...
    return {
        "generated_by": "scripts/dev/retrieval_v3_review_worklists.py",
        "totals": {
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Build retrieval_v3 object and material review worklists.")
