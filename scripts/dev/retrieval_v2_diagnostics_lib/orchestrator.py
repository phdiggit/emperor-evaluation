...
from scripts.dev.retrieval_v2_diagnostics_lib.reports import (
    fetch_coverage_checks,
    fetch_duplicate_checks,
    fetch_summary,
)
from scripts.dev.retrieval_v2_diagnostics_lib.score_chain import fetch_score_chain
...
def fetch_db_report(
    *,
    ...
    raise RetrievalV2DiagnosticsError(f"unsupported DB report command: {command}")
