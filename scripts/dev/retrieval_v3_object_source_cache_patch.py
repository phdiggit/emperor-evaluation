...
from scripts.dev.retrieval_v3_object_source_cache_audit import read_jsonl
from scripts.dev.retrieval_v3_object_source_cache_seed import seed_aliases
from scripts.dev.retrieval_v3_contracts import unique_strings
...
def apply_seed_patches(
    ...
    *,
    ...
    report = {
        "generated_by": "scripts/dev/retrieval_v3_object_source_cache_patch.py",
        "totals": totals,
...
def render_patch_report_markdown(report: Mapping[str, Any]) -> str:
    ...
    lines = [
        "# retrieval_v3 object source cache seed patch report",
        "",
        "## Totals",
        "",
    ]
