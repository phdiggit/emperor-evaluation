...
DEFAULT_CACHE_ROOT = ROOT / "tmp" / "retrieval_v3_claim_cache"
SCHEMA_VERSION = 1
PGSQL_SCHEMA_PATH = ROOT / "db" / "migrations" / "20260708_retrieval_v3_claim_cache.sql"
REUSABLE_CLAIM_STATUSES = {"active"}

from scripts.dev import retrieval_v3_alias_pretag as alias_pretag  # noqa: E402
from scripts.dev import retrieval_v3_claim_quality as claim_quality  # noqa: E402
from scripts.dev.retrieval_v3_pg_schema import render_sql  # noqa: E402
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Manage retrieval_v3 claim-only extraction cache.")
