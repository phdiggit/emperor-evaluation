...
from scripts.dev.retrieval_v3_import_plan import write_json
from scripts.dev.retrieval_v3_diagnostics_lib.common import short_text, text

def render_markdown(payload: Mapping[str, Any]) -> str:
    if payload.get("command") == "score-chain":
        return render_score_chain_markdown(payload)
    lines = [
        "# retrieval_v3 diagnostics",
        "",
