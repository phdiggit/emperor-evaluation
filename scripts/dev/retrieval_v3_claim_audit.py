...
from scripts.dev.retrieval_v3_taskgen_preseed import text_from  # noqa: E402
...
def build_claim_audit(
    *,
    ...
    return {
        "generated_by": "scripts/dev/retrieval_v3_claim_audit.py",
...
def render_markdown(report: Mapping[str, Any]) -> str:
    ...
    lines = [
        "# retrieval_v3 claim cache audit",
        "",
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Audit retrieval_v3 claim cache against annotated object source cache slices.")
