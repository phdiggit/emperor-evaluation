...
from scripts.dev.retrieval_v3_import_plan import stable_hash, write_json  # noqa: E402
...
from scripts.dev.retrieval_v3_judgment_worklists import run_codex_tasks  # noqa: E402
    ...
    *,
    ...
    cur.execute(
        ...
        select
         ...
         where mrq.queue_status = any(%s::retrieval_v3.rv3_queue_status[])
...
def build_workitems(*, dsn: str, item_code: str, scope: str, review_kinds: Sequence[str], target_names: Sequence[str], target_codes: Sequence[str], limit: int, schema_name: str = "retrieval_v3") -> list[dict[str, Any]]:
...
def prompt_for_task(*, task: Mapping[str, Any], workitems: Sequence[Mapping[str, Any]], patch_path: Path) -> str:
    return (
        "# retrieval_v3 material review task\n\n"
...
def render_markdown(*, workitems: Sequence[Mapping[str, Any]], tasks: Sequence[Mapping[str, Any]], summary: Mapping[str, Any]) -> str:
    lines = [
        "# retrieval_v3 material review tasks",
        "",
...
def write_worklist_outputs(*, output_root: Path, workitems: Sequence[Mapping[str, Any]], batch_size: int) -> dict[str, Any]:
    ...
    summary = {
        "generated_by": "scripts/dev/retrieval_v3_material_review_tasks.py",
        "totals": {
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Build Codex review tasks for retrieval_v3 material_review_queue claim/passage issues.")
