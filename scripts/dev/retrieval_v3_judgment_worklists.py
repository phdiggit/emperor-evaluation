    ...
    item = {
        ...
        "context": {
            ...
            "rubric": {
                ...
                "historic_talent": "达到时代塑造级：主导国家建立、统一、存亡或重大转型，主持基础性制度文化成果，或成为跨时代专业标杆；三条路径满足其一且个人归属性高即可。",
            },
