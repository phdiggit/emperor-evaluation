...
def render_shard_report(summary: Mapping[str, Any]) -> str:
    ...
    lines = [
        "# retrieval_v3 object source cache shard build",
        "",
        "## Summary",
        "",
...
def run_build_shards(
    ...
    *,
    ...
    script = script_path or Path(__file__).with_name("retrieval_v3_object_source_cache.py")
    ...
    summary = {
        "generated_by": "scripts/dev/retrieval_v3_object_source_cache_shards.py",
