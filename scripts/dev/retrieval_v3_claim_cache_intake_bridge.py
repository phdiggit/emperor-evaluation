...
from scripts.dev import retrieval_v3_import_plan as import_plan  # noqa: E402
...
from scripts.dev.retrieval_v3_runtime_paths import load_runtime_paths  # noqa: E402
from scripts.dev.retrieval_v3_contracts import NATIVE_CONTRACT_CODE  # noqa: E402
...
def fetch_cache_evidence_rows(cur: Any, *, claim_keys: Sequence[str]) -> list[dict[str, Any]]:
    ...
    cur.execute(
        ...
        select
          ...
          join retrieval_v3.claim_evidence e on e.claim_key = c.claim_key
          join retrieval_v3.claim_source_slices s on s.slice_hash = e.slice_hash
...
def report_from_pg(
    *,
    ...
    report = {
        "ok": True,
        "generated_by": "scripts/dev/retrieval_v3_claim_cache_intake_bridge.py",
