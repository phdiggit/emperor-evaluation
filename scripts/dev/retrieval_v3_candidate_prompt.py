...
from scripts.dev import retrieval_v3_alias_pretag as alias_pretag
from scripts.dev import retrieval_v3_claim_quality as claim_quality
...
def build_prompt(candidates: Mapping[str, Any]) -> str:
    ...
    if capture_mode == "i5b_wide_shadow":
        ...
        primary_bindings_schema = '  "primary_bindings": [],\n'
    return (
        "你是 emperor-evaluation 项目的 retrieval_v3 抓包判读 worker。本轮脚本已经完成源页抓取、缓存、别名命中和候选片段切片；"
