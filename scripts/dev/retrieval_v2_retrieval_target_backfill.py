...
from scripts.dev.retrieval_v2_bootstrap import import_psycopg, load_env_file, seed_target  # noqa: E402
from scripts.dev.retrieval_v2_bootstrap import resolve_dsn  # noqa: E402
...
from scripts.dev.retrieval_v2_object_source_cache_pg_backfill import load_cache_rows  # noqa: E402
...
select
    ...
    item_code,
    status
from retrieval_v2.rule_contracts
where status = 'active'
  and item_code = %s
...
def markdown_report(payload: Mapping[str, Any]) -> str:
    ...
    lines = [
        "# retrieval_v2 retrieval target backfill report",
        "",
