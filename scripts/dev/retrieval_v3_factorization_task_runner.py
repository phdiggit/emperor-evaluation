...
from scripts.dev.retrieval_v3_factorization_tasks import patch_path_for_task  # noqa: E402
from scripts.dev.retrieval_v3_intake_manifest import repo_relative, text  # noqa: E402


RUNNER_SOURCE = "scripts/dev/retrieval_v3_factorization_worklists.py"
...
def render_recovery_markdown(payload: Mapping[str, Any]) -> str:
    lines = [
        "# retrieval_v3 factorization patch recovery", "",
