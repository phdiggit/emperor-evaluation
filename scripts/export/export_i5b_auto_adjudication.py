...
def render_score_mapping_draft() -> str:
    ...
    lines = [
        ...
        "## 二、与现有文档的关系",
        "",
        "1. `docs/20_dimensions/第五项B/第五项B自动结算规则.md` 决定 band direction 与规则敏感点。",
        "2. `exports/markdown_views/第五项B/人工审核/自动裁判链/正式定档草案/第五项B三人正式定档落地表.md` 决定正式档位草案和分数阶段前置条件。",
        "3. 本文件只回答“如果未来正式出分，band 如何映射为相对分值区间”。",
        "4. 本文件不替代 `docs/20_dimensions/第五项B/第五项B正式工作流模板.md`。",
        "5. 本文件不替代 `docs/10_methodology/证据裁量总则_讨论版.md` 中的评分标尺关系。",
        "",
        "## 三、通用映射原则",
        "",
