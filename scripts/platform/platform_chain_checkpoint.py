...
CURRENT_STATE = {
    ...
    "g10_historical_asset_retirement_prerequisite_merge_commit": "703cae862f9fb6363315c85cce629616c8ab5de1",
    ...
    "g10_low_risk_script_lifecycle_execution_prerequisite_merge_commit": "83c2438e31842f08ed19a1a1b00e965ce1fa9451",
    ...
    "g10_script_governance_enforcement_prerequisite_merge_commit": "25d10100c88f83e0f06a8cf98203ac1e4c511858",
    ...
    "g10_completion_report_prerequisite_merge_commit": "b65618797c6f31bf83dd6723ca301e9bb27f8117",
...
COMPLETED_CHAIN = [
    ...
    "g10_low_risk_script_lifecycle_execution",
    "g10_script_governance_enforcement",
    "g10_completion_verification_handoff",
    "post_g10_followup_gates_readiness",
    "post_g10_script_lifecycle_finalization",
]
CONTRACT_ONLY_TOOLS = [
...
def build_contract_report() -> dict[str, Any]:
    return {
        ...
        "prototype_tools": [
            ...
            {
                "name": "g10_historical_asset_retirement",
                "path": "scripts/platform/g10_historical_asset_retirement.py",
                "contract": True,
                "apply": False,
            ...
            {
                "name": "g10_low_risk_script_lifecycle_execution",
                "path": "scripts/platform/g10_low_risk_script_lifecycle_execution.py",
                "contract": True,
                "apply": False,
                "boundary": "offline_g10_2b_registry_lifecycle_execution_only_no_path_mutation",
            },
            {
                "name": "validate_script_lifecycle_registry",
                "path": "scripts/validate/validate_script_lifecycle_registry.py",
                "contract": True,
                "apply": False,
                "boundary": "offline_g10_3b_registry_lifecycle_guard_only",
            },
            {
                ...
                "contract": True,
                "apply": False,
                "boundary": "offline_g10_4_completion_verification_and_roadmap_handoff_only",
            },
            {
                "name": "post_g10_followup_gates_readiness",
                "path": "scripts/platform/post_g10_followup_gates_readiness.py",
                "contract": True,
                "apply": False,
                "boundary": "offline_post_g10_followup_gates_readiness_only",
            },
            {
                "name": "post_g10_script_lifecycle_finalization",
                "path": "scripts/platform/post_g10_script_lifecycle_finalization.py",
                "contract": True,
                "apply": False,
                "boundary": "offline_post_g10_script_lifecycle_finalization_documented_script_moves_only",
            },
            {
        ...
        "strict_boundaries": [
            ...
            "g10_low_risk_script_lifecycle_execution_updates_registry_only",
            "g10_low_risk_script_lifecycle_execution_keeps_files_in_place",
            "g10_low_risk_script_lifecycle_execution_does_not_touch_data_archive_or_exports",
            "g10_low_risk_script_lifecycle_execution_requires_restore_instruction_per_item",
            "g10_script_governance_enforcement_adds_validate_all_guard",
            "g10_script_governance_enforcement_fails_bad_lifecycle_fixture",
            "g10_script_governance_enforcement_keeps_retired_scripts_out_of_default_public_routes",
            "g10_script_governance_enforcement_requires_duplicate_capability_reason_or_plan",
            "g10_completion_verification_handoff_does_not_expand_retirement_scope",
            "g10_completion_verification_handoff_does_not_move_delete_or_archive_files",
            "g10_completion_verification_handoff_does_not_publish_scores_or_rankings",
            "g10_completion_verification_handoff_requires_post_g10_followup_gates",
            "post_g10_followup_gates_readiness_does_not_execute_followup_gates",
            "post_g10_followup_gates_readiness_requires_separate_ready_review_per_gate",
            "post_g10_followup_gates_readiness_does_not_publish_scores_rankings_or_leaderboards",
            "post_g10_followup_gates_readiness_does_not_move_delete_archive_or_write_business_tables",
            "post_g10_followup_gates_readiness_does_not_enter_epic2_or_epic3",
            "post_g10_script_lifecycle_finalization_updates_registry_and_moves_large_retired_scripts",
            "post_g10_script_lifecycle_finalization_moves_only_to_documented_retired_location",
            "post_g10_script_lifecycle_finalization_extracts_active_plan_hash_and_redaction_helpers",
            "post_g10_script_lifecycle_finalization_does_not_touch_data_archive_or_exports",
            "post_g10_script_lifecycle_finalization_requires_restore_instruction_per_item",
            "post_g10_script_lifecycle_finalization_keeps_retired_scripts_out_of_default_public_routes",
            "post_g10_script_lifecycle_finalization_disallows_report_only_fallback",
        ],
        "next_epic_gates": [
