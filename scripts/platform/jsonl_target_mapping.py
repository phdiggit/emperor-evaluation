...
def build_mappings() -> dict[str, JsonlFileMapping]:
    ...
    return {
        "data/query_profiles.jsonl": JsonlFileMapping(
            ...
            candidate_fields={},
            payload_fields=("query", "query_terms", "notes", "source_scope", "search_mode"),
        ...
        "data/search_logs.jsonl": JsonlFileMapping(
            ...
            payload_fields=("result_summary", "source_scope", "search_mode", "notes"),
            reference_risk_fields={
        ...
        "data/sources.jsonl": JsonlFileMapping(
            ...
            payload_fields=("quote", "context", "raw_text", "excerpt", "notes", "meta"),
            reference_risk_fields={},
            range_filter_fields={},
            deferred_relationships={
        ...
        "data/evidence_cards.jsonl": JsonlFileMapping(
            ...
            candidate_fields={},
            payload_fields=("verification_status", "adjudication_status", "notes", "meta"),
            reference_risk_fields={
...
def anchor_mapping(source_file: str, blocked_reason: str) -> JsonlFileMapping:
    return JsonlFileMapping(
        ...
        payload_fields=("cross_item_risks", "usable_for", "notes", "meta"),
        reference_risk_fields={
