...
def redact_secret(text: str) -> str:
    redacted = text
    for scheme in ("postgresql://", "amqp://", "amqps://", "http://", "https://"):
        if scheme in redacted and "@" in redacted.split(scheme, 1)[1]:
            prefix, rest = redacted.split(scheme, 1)
            redacted = prefix + scheme + "<redacted-credentials>@" + rest.split("@", 1)[1]
