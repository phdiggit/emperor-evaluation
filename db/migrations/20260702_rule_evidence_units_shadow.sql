...
with seed(rule_code, scoring_role, predicate, relation_role, subject_obj_type, object_obj_type, direction, description) as (
    values
        ...
        ('appointment_delegation', 'appointed_actor', 'appointed_or_delegated_authority', 'scored_candidate', 'person', '', 'positive', '被任用、授职或起用的具体人物。'),
        ('appointment_delegation', 'entrusted_actor', 'appointed_or_delegated_authority', 'scored_candidate', 'person', '', 'positive', '获得信任、托付或持续倚重的具体人物。'),
        ('appointment_delegation', 'delegated_actor', 'appointed_or_delegated_authority', 'scored_candidate', 'person', '', 'positive', '获得授权并承担责任的具体人物。'),
        ('appointment_delegation', 'strategic_advisor', 'appointed_or_delegated_authority', 'scored_candidate', 'person', '', 'positive', '计策、规划或顾问意见被采纳并进入职责链的具体人物。'),
        ('appointment_delegation', 'military_commander', 'appointed_or_delegated_authority', 'scored_candidate', 'person', '', 'positive', '获得军事任命、将兵或战役职责的具体人物。'),
        ('appointment_delegation', 'civil_official', 'appointed_or_delegated_authority', 'scored_candidate', 'person', '', 'positive', '获得政务、地方、财政、法制或中枢职责的具体人物。'),
        ('appointment_delegation', 'misappointed_actor', 'misappointed_or_misdelegated_authority', 'scored_candidate', 'person', '', 'negative', '明显误任、偏信或污染任用秩序的具体人物。'),
        ('appointment_delegation', 'misdelegated_actor', 'misappointed_or_misdelegated_authority', 'scored_candidate', 'person', '', 'negative', '被错误授权或纵容用权的具体人物。'),
        ('appointment_delegation', 'misentrusted_actor', 'misappointed_or_misdelegated_authority', 'scored_candidate', 'person', '', 'negative', '被错误信任、托付并造成任用授权损害的具体人物。'),
        ('appointment_delegation', 'authority_revoked_target', 'revoked_authority', 'scored_candidate', 'person', '', 'negative', '被不当撤权或破坏权责稳定的具体人物。'),
