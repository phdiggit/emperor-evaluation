...
join retrieval_v3.person_profiles pp
 ...
 and pp.talent_grade_version in ('talent-grade-v1','talent-grade-v2','talent-grade-v3')
...
comment on column retrieval_v3.person_profiles.talent_grade_version is '人才等级规则版本；talent-grade-v3 使用房玄龄治国守门员及李绩/苏定方军事守门员。';
