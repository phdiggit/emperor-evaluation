...
join retrieval_v3.person_profiles pp
 ...
 and pp.talent_grade_version in ('talent-grade-v1','talent-grade-v2','talent-grade-v3','talent-grade-v4','talent-grade-v5')
...
comment on column retrieval_v3.person_profiles.talent_grade_version is '人才等级规则版本；talent-grade-v5 增加顶级人才分领域守门员。';
