...
CREATE TABLE v4_person_profile.person_profiles (
    ...
    talent_grade_policy_version TEXT NOT NULL,
...
CREATE INDEX person_profiles_talent_idx
    ON v4_person_profile.person_profiles (
        talent_grade_policy_version, talent_grade, review_status
    );
...
COMMENT ON COLUMN v4_person_profile.person_profiles.talent_grade_policy_version IS '产生当前人才等级的最后有效政策版本。';
